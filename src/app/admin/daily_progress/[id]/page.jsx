// /pages/admin/daily-progress/[id].js
...
export default function DailyProgressDetail({ progressData, error }) {
  ...
  const handleDelete = async () => {
    if (confirm('Êtes-vous sûr de vouloir supprimer cette entrée ?')) {
      try {
        ...
        router.push('/admin/daily-progress');
      } catch (err) {
  ...
  return (
    <>
      <Head>
        <title>Détails du suivi quotidien | Admin</title>
      </Head>

      <div className="container mx-auto p-4">
        <Link href="/admin/daily-progress">
          ...
          <div className="mt-8 border-t pt-4">
            ...
            <div className="flex space-x-4">
              <button 
                ...
                onClick={() => router.push(`/admin/daily-progress/edit/${progressData.id}`)}
              >
                Éditer
              </button>
              <button 
